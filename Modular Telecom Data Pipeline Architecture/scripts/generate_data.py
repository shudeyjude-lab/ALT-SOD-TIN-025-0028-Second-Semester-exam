...
RAW_DIR = "raw_data"   # The folder name
...
def generate_all_data():
    ...
    df_customers.to_csv(os.path.join(RAW_DIR, "src_customers.csv"), index=False)
    ...
    df_transactions.to_csv(os.path.join(RAW_DIR, "src_billing_transactions.csv"), index=False)
    ...
    df_sessions.to_csv(os.path.join(RAW_DIR, "src_network_sessions.csv"), index=False)
    ...
    print(f"Files created in '{RAW_DIR}/':")
    print("Files created:")
